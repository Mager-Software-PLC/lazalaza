  ...
  const menuItems = [
    {
      category: 'Management',
      items: [
        { href: '/admin/tours', label: 'Services', icon: MapPin, description: 'Manage services and packages', gradient: 'from-primary-500 to-ocean-500', bg: 'from-primary-50 to-ocean-50 dark:from-primary-900/20 dark:to-ocean-900/20', border: 'border-primary-200 dark:border-primary-800', hover: 'group-hover:text-primary-600 dark:group-hover:text-primary-400' },
